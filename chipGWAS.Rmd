...
chips_gxeTD <- lapply(chips_gxe, function(x){statgenSTA::createTD(data = x, genotype = "variety", trial = "trial")})
...
lapply(chipFW, function(x){plot(x, plotType = "line")})
```
